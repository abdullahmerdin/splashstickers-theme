...
assertContains('templates/index.json', '/products/the-collection-snowboard-hydrogen');
assertContains('templates/index.json', '?view=product-gangsheet');
...
assertContains('sections/header.liquid', 'z-index: 3;');
