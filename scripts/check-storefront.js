...
assertContains('sections/sticker-collection-hero.liquid', 'section.settings.show_splash_word');
assertContains('sections/sticker-collection-hero.liquid', 'section.settings.show_sticker_1');
assertContains('sections/sticker-collection-hero.liquid', 'section.settings.show_art_meta');
...
assertContains('templates/collection.json', '"show_splash_word": true');
assertContains('templates/collection.json', '"show_sticker_1": true');
assertContains('templates/collection.json', '"show_sticker_2": true');
assertContains('templates/collection.json', '"show_sticker_3": true');
assertContains('templates/collection.json', '"show_art_meta": true');
